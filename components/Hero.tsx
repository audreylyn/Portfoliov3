...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen w-full flex items-center pt-36 pb-24 md:pt-48 md:pb-32 px-6 md:px-12 border-b border-double border-stone-200 overflow-hidden transition-colors duration-500">
      {/* Background Ambient */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-stone-300/30 rounded-full blur-[120px] pointer-events-none transition-colors duration-500"></div>
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-orange-500/10 rounded-full blur-[150px] pointer-events-none transition-colors duration-500"></div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="space-y-12 order-2 lg:order-1">
            <div className="space-y-6">
                {/* Badge */}
                <div className="inline-flex items-center gap-3 px-4 py-1.5 border border-orange-500/30 bg-orange-500/5 text-xs font-bold uppercase tracking-[0.2em] text-orange-600 font-display">
                ...
                {/* Heading */}
                <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-display text-stone-900 leading-[0.95] tracking-tight">
                    Audreylyn <br />
                    <i className="font-serif font-light text-orange-600">Moraña</i> <span className="text-3xl sm:text-4xl md:text-6xl align-middle text-stone-400">&</span><br />
                    Portfolio
                </h1>

                {/* Description */}
                <p className="text-lg md:text-xl text-stone-600 max-w-lg leading-relaxed font-serif italic border-l-2 border-orange-500 pl-6">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
                <a href="#projects" className="bg-orange-600 hover:bg-orange-700 text-white px-10 py-4 font-bold tracking-widest uppercase text-xs transition-all shadow-[4px_4px_0px_0px_#1c1917] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_0px_#1c1917] border border-stone-900 text-center">
                    View Catalogue
                </a>
                <a href="#about" className="bg-transparent hover:bg-stone-100 text-stone-900 border border-stone-900 px-10 py-4 font-bold tracking-widest uppercase text-xs transition-all flex items-center justify-center gap-2">
                    About Me
                </a>
            </div>

            {/* Stats */}
            <div className="pt-8 flex flex-wrap justify-center sm:justify-start gap-4 sm:gap-8 border-t border-stone-200">
                <div className="text-center">
                    <span className="block text-2xl sm:text-3xl font-display text-orange-600 font-bold">4th</span>
                    <span className="text-[10px] uppercase tracking-widest text-stone-500">Year Student</span>
                </div>
                <div className="hidden sm:block w-px bg-stone-200 h-10 self-center"></div>
                <div className="text-center">
                    <span className="block text-2xl sm:text-3xl font-display text-orange-600 font-bold">100%</span>
                    <span className="text-[10px] uppercase tracking-widest text-stone-500">Dedication</span>
                </div>
                <div className="hidden sm:block w-px bg-stone-200 h-10 self-center"></div>
                <div className="text-center">
                    <span className="block text-2xl sm:text-3xl font-display text-orange-600 font-bold">WEB</span>
        ...
        <div className="relative group p-6 flex justify-center order-1 lg:order-2">
            ...
            <div className="absolute inset-0 border-4 border-double border-stone-900/10 rotate-1 rounded-sm"></div>
            <div className="absolute inset-0 border border-stone-900/20 -rotate-1 bg-stone-100 z-0 rounded-sm"></div>
            
            <img 
                src="images/hero_image.png" 
                alt="Audreylyn Moraña" 
                className="relative z-10 w-full max-w-md h-[500px] md:h-[600px] object-cover contrast-125 border border-stone-900/10 shadow-xl" 
            />
            ...
            <div className="absolute bottom-12 -left-2 md:-left-12 z-20">
                <div className="relative w-40 h-40 md:w-48 md:h-48 cursor-pointer group/badge">
                    ...
                    <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-xl" aria-labelledby="badge-title">
                        ...
                        {/* Cloud/Flower Shape */}
                        <path 
                            className="badge-cloud fill-white stroke-stone-200"
                            strokeWidth="1"
                        ...
                        {/* Face */}
                        <g className="badge-face stroke-stone-900" strokeWidth="2" fill="none">
                            <path d='M 95 102 Q 100 107 105 102' strokeLinecap="round" />
                            <ellipse cx='90' cy='100' rx='2' ry='2' className="fill-stone-900 stroke-none" />
                            <ellipse cx='110' cy='100' rx='2' ry='2' className="fill-stone-900 stroke-none" />
                            <ellipse cx='100' cy='100' rx='35' ry='35' className="stroke-stone-900" />
                        </g>

                        {/* Text */}
                        <text className="badge-text text-[11px] font-bold uppercase tracking-[0.1em] fill-stone-900">
